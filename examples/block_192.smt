...
(assert
 ...
 (let (($x328 (=> u_1_4 $x327)))
 (let (($x364 (and (and (= x_0_3 sk_x) (and (= x_1_3 1) (= x_0_4 s_1))) (and $x328 $x324))))
 ...
 (let (($x258 (=> u_1_3 $x257)))
 (let (($x294 (and (and (= x_0_2 sk_x) (and (= x_1_2 1) (= x_0_3 s_1))) (and $x258 $x254))))
 ...
 (let (($x181 (=> u_1_2 $x180)))
 (let (($x217 (and (and (= x_0_1 sk_x) (and (= x_1_1 1) (= x_0_2 s_1))) (and $x181 $x177))))
 ...
 (let (($x105 (=> u_1_1 $x104)))
 (let (($x140 (and (and (= x_0_0 sk_x) (and (= x_1_0 1) (= x_0_1 s_1))) (and $x105 $x100))))
