...
(assert
 ...
 (let (($x191 (=> u_0_2 $x184)))
 (let (($x196 (and $x191 $x193 $x136)))
 (let (($x194 (and $x196 $x358)))
 (let (($x195 (=> $x146 $x194)))
 ...
 (let (($x162 (=> u_2_2 $x161)))
 (let (($x186 (and $x162 $x156)))
 (let (($x158 (= x_1_2 x_0_1)))
 (let (($x187 (and $x158 $x186)))
 (let (($x183 (and $x184 $x187)))
 (let (($x167 (not u_2_1)))
 (let (($x185 (and $x167 $x183)))
 (let (($x188 (and u_0_1 $x185)))
 (let (($x190 (=> $x145 $x188)))
 (let (($x137 (and $x136 $x358)))
 (let (($x174 (= x_0_2 x_1_1)))
 (let (($x138 (and $x174 $x158)))
 (let (($x139 (and $x138 $x137)))
 (let (($x140 (and u_1_1 $x139)))
 (let (($x141 (and u_0_1 $x140)))
 (let (($x189 (=> $x144 $x141)))
 ...
 (let (($x96 (=> $x65 $x95)))
 (let (($x378 (and (and (and $x96 $x109 $x121 $x128 $x134) (or $x65 $x66 $x68 $x70 $x71)) (and (and $x169 $x181 $x189 $x190 $x195) (or $x142 $x143 $x144 $x145 $x146)))))
