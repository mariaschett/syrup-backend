...
(assert
 ...
 (let (($x68 (and $x67 $x66)))
 (let (($x69 (=> $x37 $x68)))
 (let (($x238 (and (and (and $x69 $x82 $x94 $x101 $x107) (or $x37 $x38 $x40 $x42 $x43)) (and (and $x143 $x155 $x167 $x174 $x180) (or $x119 $x120 $x121 $x122 $x123)))))
 (let (($x240 (and (and (= s_0 146) (and (= s_0 x_0_2) u_0_2)) (and $x238 $x35))))
 (and (and (= u_0_0 false) (= u_1_0 false) (= u_2_0 false)) $x240)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(get-model)