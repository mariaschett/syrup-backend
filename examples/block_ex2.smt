...
(assert
 ...
 (let (($x189 (and (=> u_2_2 (= x_2_2 x_1_1)) (and (= u_0_2 true) (= u_1_2 u_0_1) (= u_2_2 u_1_1)))))
 (let (($x158 (= x_1_2 x_0_1)))
 (let (($x188 (and u_0_1 (and (not u_2_1) (and (= x_0_2 x_0_1) (and $x158 $x189))))))
 (let (($x136 (and (=> u_2_2 (= x_2_2 x_2_1)) (and (= u_0_2 u_0_1) (= u_1_2 u_1_1) (= u_2_2 u_2_1)))))
 (let (($x141 (=> $x144 (and u_0_1 (and u_1_1 (and (and (= x_0_2 x_1_1) $x158) $x136))))))
 ...
 (let (($x376 (and (=> $x142 (and (not u_2_1) (and (= x_0_2 a_1) $x164))) (=> $x143 (and u_0_1 $x179)) $x141 (=> $x145 $x188) (=> $x146 $x194))))
 (let (($x71 (= 4 t_0)))
 (let (($x70 (= 3 t_0)))
 (let (($x68 (= 2 t_0)))
 (let (($x66 (= 1 t_0)))
