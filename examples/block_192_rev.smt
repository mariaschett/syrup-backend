...
(assert
 ...
 (let (($x359 (=> u_2_2 $x358)))
 (let (($x196 (and (=> u_0_2 (= x_0_2 x_0_1)) (=> u_1_2 (= x_1_2 x_1_1)) $x359)))
 (let (($x156 (and (= u_0_2 true) (= u_1_2 u_0_1) (= u_2_2 u_1_1))))
 (let (($x162 (=> u_2_2 (= x_2_2 x_1_1))))
 (let (($x158 (= x_1_2 x_0_1)))
 (let (($x187 (= x_0_2 x_0_1)))
 (let (($x167 (not u_2_1)))
 (let (($x190 (=> $x145 (and u_0_1 (and $x167 (and $x187 (and $x158 (and $x162 $x156))))))))
 (let (($x140 (and u_0_1 (and u_1_1 (and (and (= x_0_2 x_1_1) $x158) (and $x359 $x357))))))
 ...
 (let (($x203 (and (=> (= 0 t_1) $x168) (=> (= 1 t_1) (and u_0_1 $x179)) (=> $x144 $x140) $x190 (=> $x146 (and $x196 $x357)) $x202)))
