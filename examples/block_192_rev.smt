...
(assert
 ...
 (let (($x330 (=> u_1_4 $x324)))
 (let (($x363 (and (and (and (= x_0_3 1) (= x_1_3 sk_x)) (= x_0_4 s_1)) (and $x330 $x329))))
 ...
 (let (($x260 (=> u_1_3 $x254)))
 (let (($x293 (and (and (and (= x_0_2 1) (= x_1_2 sk_x)) (= x_0_3 s_1)) (and $x260 $x253))))
 ...
 (let (($x183 (=> u_1_2 $x177)))
 (let (($x216 (and (and (and (= x_0_1 1) (= x_1_1 sk_x)) (= x_0_2 s_1)) (and $x183 $x176))))
 ...
 (let (($x136 (and (and (and (= x_0_0 1) (= x_1_0 sk_x)) (= x_0_1 s_1)) (and $x105 $x100))))
 ...
 (let (($x377 (and (and (= s_1 1024) (= sk_x 1025)) (and $x368 (and $x63 $x50)))))
